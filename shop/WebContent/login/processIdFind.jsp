				...
				<div class="category2 container" style=width:40%;>
					<div class="col-lg-12">
						<ul class=" list-unstyled text-center">
							...
							<li style=margin-bottom:20px;><strong>고객님 아이디 찾기가 완료 되었습니다.</strong></li>
							<li style=margin-bottom:20px;><pre>고객님의 아이디 찾기가 성공적으로 이루어졌습니다.
항상 즐겁고 편리한 쇼핑을 위해 최선의 노력을 다하겠습니다.</pre></li>
							<li class="find ">
								<c:forEach var="row" items="${resultSet.rows}">
								<ul class="list-unstyled text-center">
									<li>아이디 : <strong><c:out value="${row.id}"/></strong></li>
									<li>이름 : <c:out value="${row.name}"/></li>
			...
			<div class="text-center container">
					...
					<a href="pwFind.jsp" class="btn btn-info">PW 찾기</a>
			</div>
	</section>
	<br><hr><br>
